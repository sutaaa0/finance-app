         ...
         <MenuButton/>
          ...
          <Dialog open={isAddTransactionOpen} onOpenChange={setIsAddTransactionOpen}>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                <Button type="submit" onClick={() => setIsAddTransactionOpen(false)}>Add Transaction</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <span className="text-3xl font-bold text-gray-800">$1,612.50</span>
            ...
            {activeTab === 'income' && (
              ...
              >
                ...
                <p className="text-4xl font-bold text-green-500">$5,280.00</p>
