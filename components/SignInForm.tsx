    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 items-center">
          ...
          <CardTitle className="text-2xl font-bold text-center">{isSignUp ? "Join for financial freedom" : "Welcome back"}</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button className="w-full" type="submit" disabled={isLoading}>
              {isLoading ? <motion.div className="h-5 w-5 rounded-full border-t-2 border-r-2 border-white" animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }} /> : isSignUp ? "Sign up" : "Log in"}
            </Button>
          </form>
